...
* aws-node-16-lambda-step-function:StockTradingStateMachine
* aws-node-16-lambda-step-function:Queue (nodejs16.x)
* aws-node-16-lambda-step-function:Approve (nodejs16.x)
* aws-node-16-lambda-step-function:Failure (nodejs16.x)
* aws-node-16-lambda-step-function:TransactionTable
